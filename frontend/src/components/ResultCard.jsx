...
export default function ResultCard({
  ...
  const severityStates = {
    ...
    INVALID_IMAGE: {
      title: "No result as the image is not valid",
      subtitle: "Not a Retinal Fundus Photograph",
      badge: "Invalid Photograph",
      gradient: "from-rose-950 via-red-900 to-slate-950",
      accentBg: "bg-rose-500/20 border-rose-400/40 text-rose-200",
      statusText: "Verification Failed: Non-Retinal Image Detected",
      summary: "The captured photograph does not contain human retinal fundus structures (optic disc, retinal vasculature, or macula). Automated diabetic retinopathy diagnosis cannot be performed.",
      urgency: "Capture or Upload a Valid Retinal Fundus Photograph",
      icon: HelpCircle
    },
    RETAKE_REQUIRED: {
      ...
      accentBg: "bg-amber-500/20 border-amber-400/40 text-amber-200",
      statusText: "Quality Warning: Image Clarity Insufficient",
      summary: "Retinal morphology detected, but excessive motion blur, optical defocus, or dark illumination obscures microvascular details.",
      urgency: "Recapture Image Ensuring Steady Focus & Illumination",
      icon: AlertTriangle
    }
  };
